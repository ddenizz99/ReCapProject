...
namespace Core.Utilities.Mail
{
    public class MailManager : IMailService
    {
        ...
        public void Send(EmailMessage emailMessage)
        {
            ...
            var messageBody = string.Format(emailMessage.Content, emailMessage.Subject);
            ...
            using (var emailClient = new SmtpClient())
            {
                ...
                emailClient.Authenticate(_configuration.GetSection("EmailConfiguration").GetSection("UserName").Value,
